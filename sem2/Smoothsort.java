...
/**
 * Created by birthright on 18.03.15.
 */
public class Smoothsort {
    ...
    public static <C extends Comparable<? super C>> void sort(C[] m,
                                                              int start, int end) {
        counter = 0;
        int head = start; // the offset of the first element of the prefix into m
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        LinkedHashMap<Integer, Long> a = new LinkedHashMap<>();
        for (int i = 1, j = 50; i <= 200; i++, j = j + 50) {
        ...
        b.entrySet().forEach(System.out::println);
    }
}
