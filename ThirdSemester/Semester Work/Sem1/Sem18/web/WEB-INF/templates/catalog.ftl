...
<table class="cat_table2" align="center" style="width: 90%;">
    ...
    <tbody valign="middle" align="center">
        <#list submodels as submodel>
            ...
            <tr style="background-color:#FFFFFF">
                <td align="left" width="35%"><a href="${submodel.getUrl()}" class="my_link"
                                                title="${submodel.getName_brand()} ${submodel.getName()}">${submodel.getName_brand()} ${submodel.getName()}</a>
                </td>
                ...
                <td align="left" width="10%"><b>${submodel.getCapacity()}</b></td>
...
<#elseif type==4>
    <#if modify??>
    <div align="center">
        <h1 class="bullet_model" title="${modify.getName_brand()} ${modify.getName()} -  технические характеристики">
        ${modify.getName_brand()} ${modify.getName()}</h1>
    </div>
    <div align="center">
        <h2>Технические характеристики ${modify.getName_brand()} ${modify.getName()}</h2>
    </div>
    <table cellpadding="0" cellspacing="0" width="600" align="center" border="0">
        ...
        <tr>
            <td width="50%" class="border_bottom">Длина * Ширина * Высота, мм<sup>3</sup></td>
            <td width="50%" class="border_bottom"><b>${modify.getSize()}</b></td>
        </tr>

        <tr>
            <td width="50%" class="border_bottom">Снаряженная масса, кг</td>
            <td width="50%" class="border_bottom"><b>${modify.getWeight()}</b></td>
        </tr>

        <tr>
            <td width="50%" class="border_bottom">Клиренс</td>
            <td width="50%" class="border_bottom"><b>${modify.getClearence()}</b></td>
        </tr>

        <tr>
            <td width="50%" class="border_bottom">Мощность двигателя, л.с / оборотах</td>
            <td width="50%" class="border_bottom"><b>${modify.getPower()}</b></td>
        </tr>
        <tr>
            <td width="50%" class="border_bottom">Рабочий объем двигателя, см³</td>
            <td width="50%" class="border_bottom"><b>${modify.getCapacity()}</b></td>
        </tr>
        <tr>
            <td width="50%" class="border_bottom">Крутящий момент, Н·м / оборотах</td>
            <td width="50%" class="border_bottom"><b>${modify.getTorque()}</b></td>
        </tr>
        <tr>
            <td width="50%" class="border_bottom">Вид топлива</td>
            <td width="50%" class="border_bottom"><b>${modify.getFuel()}</b></td>
        </tr>

        <tr>
            <td width="50%" class="border_bottom">Время разгона до 100 км/ч, сек</td>
            <td width="50%" class="border_bottom"><b>${modify.getAcceleration()}</b></td>
        </tr>


        <tr>
            <td width="50%" class="border_bottom">Тип коробки передач</td>
            <td width="50%" class="border_bottom"><b>${modify.getGearBox()}</b></td>
        </tr>

        <tr>
            <td width="50%" class="border_bottom">Привод</td>
            <td width="50%" class="border_bottom"><b>${modify.getDrive()}</b></td>
        </tr>
        <tr>
            <td width="50%" class="border_bottom">Размер шин</td>
            <td width="50%" class="border_bottom"><b>${modify.getTires()}</b></td>
        </tr>
        <tr>
            <td width="50%" class="border_bottom">Размер дисков</td>
            <td width="50%" class="border_bottom"><b>${modify.getDisk()}</b></td>
        </tr>
        </tbody>
    </table>
    </#if>
