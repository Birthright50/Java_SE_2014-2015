...
public class AutoModifyRepository {
    public AutoModify getAuto(String name_brand, String name_model, String name_submodel) {
        ...
        try {
            preparedStatement = connection.prepareStatement("SELECT * FROM auto_modify where name_brand = ? AND name_model = ? AND name = ?");
            ...
            if (resultSet.next()) {
                ...
                autoModify.setGearBox(resultSet.getString("gearBox"));
