...
public class UserRepositoryImpl implements UserRepository {
    ...
    public Integer updateUser(User event) {
        ...
        PreparedStatement preparedStatement;
        try {
            preparedStatement = connection.prepareStatement("UPDATE users SET region = ?, email = ?, password = ?, year_st = ?, car_mark = ? where login = ? ");
            ...
            preparedStatement.setString(6, event.getLogin());
