...
create table users("id" integer not null primary key, "login" varchar(255) not null, "password" varchar(255) not null, "salt" varchar(255) not null, "email" varchar(255) not null, "region" varchar(255), "first_name" varchar(255), "last_name" varchar(255), "date" Date not null, "year_st" integer not null, "gender" varchar(6) not null, "car_mark" varchar(255) not null);
